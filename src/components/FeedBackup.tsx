...
import OptimizedCommentBox from "./OptimizedCommentBox";
import ReactionPopupExample from "./ReactionPopupExample";
import TimelineDropdown from "./TimelimeDropdown";
import ReactionButtonPost from "./ReactionButtonPost";
...
const Feed = () => {
  ...
  const handleClickForComment = () => {
    setIsClickedForComment((prev) => !prev);
  };
  ...
  const [postVisibility, setPostVisibility] = useState("public"); // default public
  ...
  const handleUpload = async () => {
    if (!postContent.trim()) return; // Require content but not image
  ...
  const submitPost = async (base64Image: string) => {
    try {
      const res = await fetch("/api/posts/create", {
        ...
        body: JSON.stringify({
          title: postContent,
          image: base64Image || undefined, // Send undefined if no image
  ...
  useEffect(() => {
    const fetchPosts = async (page: number = 1, append: boolean = false) => {
      try {
        const res = await fetch(`/api/posts/getAllPosts?page=${page}&limit=10`);
        const data = await res.json();
    ...
    // Reset and fetch fresh posts when isClicked changes
    if (isClicked) {
      fetchPosts(1, false); // This will reset posts in the fetchPosts function
    } else if (posts.length === 0) {
      fetchPosts(1, false);
    }
  }, [isClicked, posts.length]);
                ...
                >
                  <div className="_nav_profile_dropdown_info">
                    ...
                    <div className="_nav_profile_dropdown_info_txt">
                      ...
                      <a className="_nav_drop_profile">View Profile</a>
                    </div>
                  </div>
                  <hr />
              ...
              <div className="row">
                <div className="col-xl-12 col-lg-12 col-md-12">
                  <ul className="_mobile_navigation_bottom_list">
                    ...
                    {/* <li className="_mobile_navigation_bottom_item">
              <a  className="_mobile_navigation_bottom_link">
                  ...
                  <div className="_layout_middle_inner">
                    ...
                    <div className="_feed_inner_text_area  _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
                      <div className="_feed_inner_text_area_box">
                        ...
                        {/* Dropdown for Private/Public */}
                        <div style={{ marginTop: "0.5rem", width: "160px" }}>
                          <select
                      ...
                      <div className="_feed_inner_text_area_bottom">
                        <div className="_feed_inner_text_area_item">
                          <div className="_feed_inner_text_area_bottom_photo _feed_common">
                            ...
                            {/* {image && (
                              <button onClick={handleUpload}>Uploads</button> // optional: upload button
                            )} */}
                          </div>
                    ...
                    {/* Timeline Posts - repeated twice in the original HTML */}
                    {posts.map((post, index) => (
                      ...
                      >
                          ...
                          <div className="_feed_inner_timeline_post_top">
                            <div className="_feed_inner_timeline_post_box">
                              <div className="_feed_inner_timeline_post_box_image">
                                <img
                                  src={
                                    post.image || "/assets/images/txt_img.png"
                                  }
                                  alt=""
                                  className="_post_img"
                        ...
                        {/* Reactions, comments, etc. would continue here */}
                        <div className="_feed_inner_timeline_total_reacts _padd_r24 _padd_l24 _mar_b26">
                          <div className="_feed_inner_timeline_total_reacts_image w-60!">
                            <ReactionPopupExample post={post} />
                        ...
                        <div
                          className="_feed_inner_timeline_reaction relative"
                          style={{
                            maxHeight: "4rem",
                          }}
                        >
                        ...
                        <CommentForm
                          postId={post?._id}
                          userId={user?._id}
                          handleClick={handleClickForComment}
                        />
                        ...
                        <div className="_timline_comment_main">
                          ...
                          <OptimizedCommentBox
                            postId={post?._id}
                            userId={user?._id}
                            initialCommentCount={post?.totalComments || 0}
                          />
                        </div>
                      </div>
                    ))}
                  ...
                  <div className="_layout_right_sidebar_inner">
                    <div className="_feed_right_inner_area_card  _padd_t24  _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
                      ...
                      <div className="_feed_bottom_fixed">
                        ...
                        {/* Repeat similar structure for other friend items */}
                        <div className="_feed_right_inner_area_card_ppl _feed_right_inner_area_card_ppl_inactive">
                          <div className="_feed_right_inner_area_card_ppl_box">
                            <div className="_feed_right_inner_area_card_ppl_image">
                              <a>
